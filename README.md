# genpark-prospect-intent-prewarm-outreach-sequencer-skill
...
> **GenPark AI Agent Skill** -- Prospect intent scoring and pre-warm outreach sequencer analyzing buying signals (Fuzzy AI style)
